export const metadata = {
  title: 'Reset Password - QuickNotes',
  description: 'Reset your Quick Notes account password securely and conveniently. Get back to managing your notes effortlessly!',
  keywords: ['reset password', 'Quick Notes', 'notes app', 'secure password reset'],
  author: 'Mutasim',
}
