          ...
          <div className="relative bg-gray-900 rounded-lg py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Looking for additional resources?</h3>
                <p className="text-gray-300 text-lg mb-6">Explore our collection of tutorials and guides to enhance your productivity and efficiency.</p>
